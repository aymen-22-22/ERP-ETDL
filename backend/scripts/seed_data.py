...
DTF_PRODUCTS = [
    {
        "name": "DTF Pro Film Roll 60cm x 100m",
        "sku": "FLM-60-100",
        "price": 89.99,
        "cost_price": 65.00,
        "category": "Films",
    ...
    {
        "name": "DTF Pro Film Roll 30cm x 100m",
        "sku": "FLM-30-100",
        "price": 49.99,
        "cost_price": 35.00,
        "category": "Films",
    ...
    {
        "name": "DTF Pro Film A4 Sheets (100pk)",
        "sku": "FLM-A4-100",
        "price": 24.99,
        "cost_price": 17.00,
        "category": "Films",
    ...
    {
        "name": "Hot-Melt Adhesive Powder — Fine 20kg",
        "sku": "PWD-FINE-20",
        "price": 79.99,
        "cost_price": 55.00,
        "category": "Powders",
    ...
    {
        "name": "Hot-Melt Adhesive Powder — Coarse 20kg",
        "sku": "PWD-CRS-20",
        "price": 74.99,
        "cost_price": 52.00,
        "category": "Powders",
    ...
    {
        "name": "Hot-Melt Adhesive Powder — Fine 1kg",
        "sku": "PWD-FINE-1",
        "price": 5.99,
        "cost_price": 3.50,
        "category": "Powders",
    ...
    {
        "name": "ColorJet CMYK Ink Set 1L x 4",
        "sku": "INK-CMYK-1L",
        "price": 129.99,
        "cost_price": 90.00,
        "category": "Inks",
    ...
    {
        "name": "ColorJet White DTF Ink 1L",
        "sku": "INK-WHT-1L",
        "price": 44.99,
        "cost_price": 30.00,
        "category": "Inks",
    ...
    {
        "name": "ColorJet CMYK Ink Set 500ml x 4",
        "sku": "INK-CMYK-500",
        "price": 74.99,
        "cost_price": 52.00,
        "category": "Inks",
    ...
    {
        "name": "PrintMaster A3 DTF Printer",
        "sku": "PRN-A3-DTF",
        "price": 3499.99,
        "cost_price": 2500.00,
        "category": "Printers & Parts",
        "brand": "PrintMaster",
        "unit": "Piece",
    },
    {
        "name": "PrintMaster A4 DTF Printer",
        "sku": "PRN-A4-DTF",
        "price": 2199.99,
        "cost_price": 1600.00,
        "category": "Printers & Parts",
    ...
    {
        "name": "HeatCraft Pro 38x38 Clamshell Press",
        "sku": "HPR-38C-CLM",
        "price": 599.99,
        "cost_price": 420.00,
    ...
    {
        "name": "HeatCraft Pro 40x50 Swing-Away Press",
        "sku": "HPR-40S-SW",
        "price": 799.99,
        "cost_price": 560.00,
        "category": "Heat Presses",
    ...
    {
        "name": "HeatCraft Mini Press 15x15",
        "sku": "HPR-15-MINI",
        "price": 249.99,
        "cost_price": 175.00,
        "category": "Heat Presses",
    ...
    {
        "name": "Heat Tape — 2 inch x 50m Roll",
        "sku": "CON-TAPE-2",
        "price": 12.99,
        "cost_price": 8.00,
    ...
    {
        "name": "Cleaning Kit — PrintHead & Lines",
        "sku": "ACC-CLN-KIT",
        "price": 34.99,
        "cost_price": 22.00,
...
async def seed() -> None:
    ...
    async with async_session_factory() as session:
        ...
        print(
            f"Seeded {len(DTF_CATEGORIES)} categories, "
